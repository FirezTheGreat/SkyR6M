...
module.exports = class Submit extends Command {
    ...
    async InteractionRun(interaction) {
        try {
            ...
            if (match.players.some(({ id }) => id !== interaction.user.id)) return await interaction.reply({ content: '*You cannot submit screenshots for matches you haven\'t participated!*', ephemeral: true });
